...
export default function Contact() {
  ...
  return (
    <div className="formWrapper w-full max-w-md p-8 border border-gray-300 rounded-lg shadow-lg mx-auto bg-background text-foreground mt-12">
            ...
            <div key={index}>
              ...
              <Input
                ...
                className={`inputField border p-2 w-full rounded-md ${
                  formik.errors[field] ? "border-red-500" : "border-gray-300 dark:border-gray-300"
                }`}
              />
